  ...
  .index-header
    ...
    .anony-srh
      form(action='', method='get')
        ...
        input(class='bn', type='submit', value='')
    .anony-nav-links
      ul
        li(v-for='item in navLinks')
          a(class='{{item.class}} nav-link', target='_blank', href='{{item.link}}')
</template>
...
.anony-nav-links ul li a {
  background: url('https://img3.doubanio.com/f/sns/a98a716a173efb01ba787c966b4ba337b7cf9f55/pics/sns/anony_home/anony_nav_logo@2x.png') no-repeat 100% 100%;
  width: 40px;
  height: 20px;
  zoom: 1;
  overflow: hidden;
...
.anony-nav-links ul li .lnk-book {
  background-position: 0px 0px;
}

.anony-nav-links ul li .lnk-movie {
  background-position: -60px 0px;
}

.anony-nav-links ul li .lnk-music {
  background-position: -120px 0px;
}

.anony-nav-links ul li .lnk-group {
  background-position: -180px 0px;
}

.anony-nav-links ul li .lnk-fm {
  background-position: -240px 0px;
}

.anony-nav-links ul li .lnk-events {
  background-position: -300px 0px;
}

.anony-nav-links ul li .lnk-dongxi {
  background-position: -360px 0px;
}

.anony-nav-links ul li .lnk-market {
